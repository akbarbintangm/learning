...
@section('pageBreadcumb')
    ...
    <li class="breadcrumb-item active"><a class="text-secondary">Dashboard Sekolah</a></li>
@endsection
        ...
        <a href="{{ url('/admin/school/detail/school_dashboard') }}" class="nav-link bg-purple rounded shadow">
            <div class="row justify-content-center">
                ...
                <div class="col-10 align-self-center">
                    ...
                    <br>
                    <p class="text-light font-weight-light">Materi dan tugas yang diberikan oleh guru</p>
                </div>
            </div>
        </a>
    </li>

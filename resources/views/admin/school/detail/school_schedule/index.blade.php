...
@section('pageBreadcumb')
    ...
    <li class="breadcrumb-item active"><a class="text-secondary">Jadwal Sekolah</a></li>
@endsection
...
@section('pageMenuSidebar')
    ...
    <li class="nav-item p3 mt-1 mb-1">
        <a href="{{ url('/admin/school/detail/school_schedule') }}" class="nav-link bg-purple rounded shadow">
            <div class="row justify-content-center">
                <div class="col-2 text-center align-self-center">
                    <i class="nav-icon fas fa-book-open text-white"></i>
                </div>
                <div class="col-10 align-self-center">
                    <p class="font-weight-bold text-uppercase">Data Jadwal</p>
                    <br>
                    <p class="text-light font-weight-light">Data semua jadwal pada mapel kelas</p>
                </div>
            </div>
        </a>
    </li>

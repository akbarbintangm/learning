...
@section('pageBreadcumb')
    ...
    <li class="breadcrumb-item active"><a class="text-secondary">Data Siswa</a></li>
@endsection
...
@section('pageMenuSidebar')
    ...
    <li class="nav-item p3 mt-1 mb-1">
        <a href="{{ url('/admin/school/detail/school_student') }}" class="nav-link bg-purple rounded shadow">
            <div class="row justify-content-center">
                <div class="col-2 text-center align-self-center">
                ...
                <div class="col-10 align-self-center">
                    ...
                    <br>
                    <p class="text-light font-weight-light">Data semua siswa pada sekolah</p>
                </div>
            </div>
        </a>
    </li>
